...
import { processAllVideoQueues } from './services/videoQueueService.js';
...
class TitanBot extends Client {
  ...
  setupCronJobs() {
    ...
    // Envía 1 video de la cola cada día a las 12:00
    cron.schedule('0 12 * * *', runSafeTask('video_queue', () => processAllVideoQueues(this)));
  }
